sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("edu/opensap/fiux2/am/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("edu.opensap.fiux2.am.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["edu/opensap/fiux2/am/localService/mockserver"], function (mockserver) {
