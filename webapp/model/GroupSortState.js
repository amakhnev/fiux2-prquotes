sap.ui.define([
	...
	return BaseObject.extend("edu.opensap.fiux2.am.model.GroupSortState", {
		 ...
		 * @alias edu.opensap.fiux2.am.model.GroupSortState
		 */
		...
		/**
		 * Sorts by ProductDescription, or by Quantity
		 *
		...
		/**
		 * Groups by DeliveryDate, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "DeliveryDate") {
				...
				this._oViewModel.setProperty("/sortBy", "DeliveryDate");
				...
				this._oViewModel.setProperty("/sortBy", "ProductDescription");
			}
